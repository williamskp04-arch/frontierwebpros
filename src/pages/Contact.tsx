    ...
    <div className="bg-mist min-h-screen py-24 px-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-20">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-display text-forest mb-6 tracking-tight">Let's <span className="italic font-light text-earth/60">Connect.</span></h1>
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                <motion.div 
                  ...
                  exit={{ opacity: 0, y: -20 }}
                  className="bg-white p-16 rounded-[2rem] border border-forest/5 text-center shadow-sm"
                >
                  <div className="w-20 h-20 bg-forest text-mist flex items-center justify-center rounded-full mx-auto mb-8">
                    <Send className="w-8 h-8" />
                  </div>
                  <h2 className="text-3xl font-display text-forest mb-4">Message Sent!</h2>
                ...
                <motion.form 
                  ...
                  className="space-y-8 bg-white p-12 rounded-[2rem] shadow-sm border border-forest/5"
                >
                  {error && (
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-8">
                <ContactInfoItem 
                  icon={<Mail />}
                  title="Email"
                  content="frontoffice@frontierwebpros.com"
                  href="mailto:frontoffice@frontierwebpros.com"
                />
                <ContactInfoItem 
                  icon={<Phone />}
                  title="Phone"
